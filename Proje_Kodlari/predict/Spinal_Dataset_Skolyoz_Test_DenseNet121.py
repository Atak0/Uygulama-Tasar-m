"""
Spinal-AI2024 Skolyoz Test Pipeline - DenseNet121
=================================================
Bu script:
...
OUTPUT_DIR = BASE_DIR / "spinal_test_results_densenet121"
...
def resolve_model_path():
    try:
        return resolve_model_path_common(WEIGHTS_PATH, family="densenet121", default_path=WEIGHTS_PATH)
...
def build_densenet121_model():
    ...
    x = layers.Dropout(0.125, name="dropout_3")(x)
...
def load_model():
    ...
    print(f"[↑] DenseNet121 modeli yukleniyor: {model_path}")
    try:
...
def print_report(report):
    print("\n" + "=" * 55)
    print("  SKOLYOZ TESPIT RAPORU — DenseNet121")
    print("=" * 55)
...
def save_outputs(results, report):
    ...
    fig.suptitle("Spinal-AI2024 × DenseNet121 — Skolyoz Tespit Raporu",
...
def main():
    print("=" * 55)
    print("  Spinal-AI2024 Skolyoz Test Pipeline - DenseNet121")
    print("=" * 55)
